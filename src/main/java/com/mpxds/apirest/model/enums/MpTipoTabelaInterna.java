...
public enum MpTipoTabelaInterna {
	//
	TB_CATEGORIA_PRODUTIVIDADE("Tabela Categoria Produtividade", "c", 150, false, null),
	TB_TIPO_SERVICO_PRODUTIVIDADE("Tabela Tipo Serviço Produtividade", "c", 150, false, null),
