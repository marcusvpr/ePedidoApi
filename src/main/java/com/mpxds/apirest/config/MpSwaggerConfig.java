...
public class MpSwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.mpxds.apirest.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Spring Boot",
				"API Spring Boot - MPXDS", 
				"Versão 1.0",
				"https://www.mpxds.com.br/terms",
				new Contact("Marcus Rodrigues", "www.mpxds.com.br", "marcus_vpr@hotmail.com"),
